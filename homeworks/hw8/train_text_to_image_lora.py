...
def main():
    ...
    # Load via pipeline to avoid tokenizer download issues, then extract components
            ...
            if accelerator.sync_gradients:
                ...
                if global_step % args.checkpointing_steps == 0:
                    if accelerator.is_main_process:
                        ...
                        # Save validation images alongside checkpoint
                        if args.validation_prompt is not None:
                            logger.info(f"Generating validation images for checkpoint {global_step}...")
                            ...
                            # Create validation images directory inside checkpoint
                            val_images_dir = os.path.join(save_path, "validation_images")
                            ...
                            with autocast_ctx:
                                for i in range(args.num_validation_images):
                                    ...
                                    image.save(os.path.join(val_images_dir, f"val_image_{i}.png"))
                            
                            logger.info(f"Saved {args.num_validation_images} validation images to {val_images_dir}")
